...
const deliveryDetailsSchema = new mongoose.Schema({
  ...
  deliveryStatus: {
    type: String,
    enum: Object.values(CONSTANTS.FOOD.DELIVERY_STATUS),
    default: "Pending",
  },
});
...
const foodOrderSchema = new mongoose.Schema({
  ...
  orderStatus: {
    type: String,
    enum: Object.values(CONSTANTS.FOOD.ORDER_STATUS),
    default: "Placed",
  },
...
module.exports = mongoose.model("food_orders", foodOrderSchema);
