...
const RestaurantSchema = {
    ...
    UpdateRestaurantDetails: Joi.object({

       basic_details: Joi.object({
                    restaurant_name: Joi.string().regex(CONSTANTS.REGEX.PERSON_NAME).required(),
                    owner_name: Joi.string().regex(CONSTANTS.REGEX.PERSON_NAME).required(),
    ...
    ChangeAvailabilty: Joi.object().keys({
        availability_status: Joi.string().valid(...Object.values(CONSTANTS.AVAILABILITY_STATUS)).required(),
    }),
